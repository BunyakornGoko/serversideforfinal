...
<div style="margin-left: 20vh">
    <a href="InsertServlet">INSERTOFFICE</a><br>
    <a href="UpdateServlet">UPDATEOFFICE</a><br>
    <a href="DeleteServlet">DELTEOFFICE</a><br>
    <a href="FindbycityorcountryServlet">FINDBYCITYORCOUNTRYOFFICE</a>
</div>
